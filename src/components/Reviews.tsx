...
const PHONES = [
    "/testimonials/testim1.png",
    "/testimonials/testim2.png",
    "/testimonials/testim3.png",
    "/testimonials/testim4.png",
    "/testimonials/testim5.png",
    "/testimonials/testim6.png",
]
...
export function Reviews() {
    return <MaxWidthWrapper className="relative max-w-5xl">
        <img src="/what-people-are-buying.png" alt="buying image" aria-hidden="true" className="absolute select-none hidden xl:block -left-32 top-1/3" />
        <ReviewGrid />
    </MaxWidthWrapper>
}